...
namespace App\Models {
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<BPForm>|BPForm whereId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPForm>|BPForm wherePatientId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPForm>|BPForm whereSchoolNurseId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPForm>|BPForm whereRecordedBy($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPForm>|BPForm whereStatus($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPForm>|BPForm whereCreatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPForm>|BPForm whereUpdatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPForm>|BPForm whereUpdatedBy($value)
   ...
   * @property bool|null $has_signature
   * @property string $blood_pressure
   * @property string $time
   * @property string $date
   * @property int $bp_form_id
   * @property int $id
   * @property-read \App\Models\BPForm $bpForm
   * @method static \Illuminate\Database\Eloquent\Builder<BPReading>|BPReading whereId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPReading>|BPReading whereBpFormId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPReading>|BPReading whereDate($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPReading>|BPReading whereTime($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPReading>|BPReading whereBloodPressure($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPReading>|BPReading whereHasSignature($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPReading>|BPReading whereRemarks($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPReading>|BPReading whereCreatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder<BPReading>|BPReading whereUpdatedAt($value)
   ...
   * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\FDARFormCommonDisease> $allDiseases
   * @property-read int|null $allDiseases_count
  ...
  /**
   * App\Models\FDARFormCommonDisease
   *
   * @property \Illuminate\Support\Carbon|null $updated_at
   * @property \Illuminate\Support\Carbon|null $created_at
   * @property string|null $custom_disease
   * @property int|null $common_disease_id
   * @property int $fdar_form_id
   * @property int $id
   * @property-read \App\Models\FDARForm $fdarForm
   * @property-read \App\Models\CommonDisease $commonDisease
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereFdarFormId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereCommonDiseaseId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereCustomDisease($value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereCreatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereUpdatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease newModelQuery()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease newQuery()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease query()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease select(array|mixed $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease selectSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease selectRaw(string $expression)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease fromSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease fromRaw(string $expression, mixed $bindings)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease addSelect(array|mixed $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease distinct()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease from(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $table, string|null $as)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease useIndex(string $index)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease forceIndex(string $index)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease ignoreIndex(string $index)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease join(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second, string $type, bool $where)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease joinWhere(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string $operator, \Illuminate\Contracts\Database\Query\Expression|string $second, string $type)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease joinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second, string $type, bool $where)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease joinLateral(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease leftJoinLateral(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease leftJoin(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease leftJoinWhere(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease leftJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease rightJoin(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease rightJoinWhere(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string $operator, \Illuminate\Contracts\Database\Query\Expression|string $second)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease rightJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease crossJoin(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string|null $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease crossJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease mergeWheres(array $wheres, array $bindings)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease where(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value, string $boolean)
   * @method static array prepareValueAndOperator(string $value, string $operator, bool $useDefault)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhere(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNot(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereNot(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereColumn(\Illuminate\Contracts\Database\Query\Expression|string|array $first, string|null $operator, string|null $second, string|null $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereColumn(\Illuminate\Contracts\Database\Query\Expression|string|array $first, string|null $operator, string|null $second)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereRaw(string $sql, mixed $bindings, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereRaw(string $sql, mixed $bindings)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNotLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereNotLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNotIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereNotIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereIntegerInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereIntegerInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereIntegerNotInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereIntegerNotInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNull(string|array|\Illuminate\Contracts\Database\Query\Expression $columns, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereNull(string|array|\Illuminate\Contracts\Database\Query\Expression $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNotNull(string|array|\Illuminate\Contracts\Database\Query\Expression $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereBetween(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereBetween(\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNotBetween(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNotBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereNotBetween(\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereNotBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereNotNull(\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereDate(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereDate(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereTime(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereTime(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereDay(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereDay(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereMonth(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereMonth(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereYear(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereYear(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNested(string $boolean)
   * @method static \Illuminate\Database\Query\Builder forNestedWhere()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease addNestedWhereQuery(\Illuminate\Database\Query\Builder $query, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNotExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereNotExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease addWhereExistsQuery(string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereRowValues(array $columns, string $operator, array $values, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereRowValues(array $columns, string $operator, array $values)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereJsonContains(string $column, mixed $value, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereJsonContains(string $column, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereJsonDoesntContain(string $column, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereJsonDoesntContain(string $column, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereJsonOverlaps(string $column, mixed $value, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereJsonOverlaps(string $column, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereJsonDoesntOverlap(string $column, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereJsonDoesntOverlap(string $column, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereJsonContainsKey(string $column, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereJsonContainsKey(string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereJsonDoesntContainKey(string $column, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereJsonDoesntContainKey(string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereJsonLength(string $column, mixed $operator, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereJsonLength(string $column, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease dynamicWhere(string $method, array $parameters)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereFullText(string|string[] $columns, string $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereFullText(string|string[] $columns, string $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereAll(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereAll(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereAny(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereAny(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNone(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereNone(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease groupBy(array|\Illuminate\Contracts\Database\Query\Expression|string ...$groups)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease groupByRaw(string $sql)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease having(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, string|int|float|null $operator, string|int|float|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orHaving(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, string|int|float|null $operator, string|int|float|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease havingNested(string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease addNestedHavingQuery(\Illuminate\Database\Query\Builder $query, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease havingNull(array|string $columns, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orHavingNull(string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease havingNotNull(array|string $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orHavingNotNull(string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease havingBetween(string $column, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease havingRaw(string $sql, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orHavingRaw(string $sql)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orderBy(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column, string $direction)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orderByDesc(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease latest(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease oldest(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease inRandomOrder(string|int $seed)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orderByRaw(string $sql, array $bindings)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease skip(int $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease offset(int $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease take(int $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease limit(int $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease groupLimit(int $value, string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease forPage(int $page, int $perPage)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease forPageBeforeId(int $perPage, int|null $lastId, string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease forPageAfterId(int $perPage, int|null $lastId, string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease reorder(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string|null $column, string $direction)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease union(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $query, bool $all)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease unionAll(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $query)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease lock(string|bool $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease lockForUpdate()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease sharedLock()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease beforeQuery()
   * @method static void applyBeforeQueryCallbacks()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease afterQuery()
   * @method static mixed applyAfterQueryCallbacks(mixed $result)
   * @method static string toSql()
   * @method static string toRawSql()
   * @method static FDARFormCommonDisease|null find(int|string $id, array|string $columns)
   * @method static mixed findOr(mixed $id, callable|list<string>|string $columns, callable|null $callback)
   * @method static mixed value(string $column)
   * @method static mixed rawValue()
   * @method static mixed soleValue(string $column)
   ...
   * @method static array getBindings()
   * @method static array getRawBindings()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease setBindings(string $type)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease addBinding(mixed $value, string $type)
   * @method static mixed castBinding(mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease mergeBindings()
   * @method static array cleanBindings()
   * @method static \Illuminate\Database\ConnectionInterface getConnection()
   * @method static \Illuminate\Database\Query\Processors\Processor getProcessor()
   * @method static \Illuminate\Database\Query\Grammars\Grammar getGrammar()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease useWritePdo()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease clone()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease cloneWithout()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease cloneWithoutBindings()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease dump(mixed ...$args)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease dumpRawSql()
   * @method static void dd()
   * @method static void ddRawSql()
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease wherePast(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNowOrPast(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWherePast(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereNowOrPast(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereFuture(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereNowOrFuture(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereFuture(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereNowOrFuture(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereToday(array|string $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereBeforeToday(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereTodayOrBefore(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereAfterToday(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease whereTodayOrAfter(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereToday(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereBeforeToday(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereTodayOrBefore(array|string $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereAfterToday(array|string $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease orWhereTodayOrAfter(array|string $columns, string $boolean)
   * @method static bool chunk(int $count, callable $callback)
   * @method static mixed chunkMap(callable $callback, int $count)
   * @method static bool each(callable $callback, int $count)
   * @method static bool chunkById(int $count, callable $callback, string|null $column, string|null $alias)
   ...
   * @method static mixed lazyById(int $chunkSize, string|null $column, string|null $alias)
   * @method static mixed lazyByIdDesc(int $chunkSize, string|null $column, string|null $alias)
   * @method static FDARFormCommonDisease|null first(array|string $columns)
   * @method static FDARFormCommonDisease firstOrFail(array|string $columns, string|null $message)
   * @method static FDARFormCommonDisease sole(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<FDARFormCommonDisease>|FDARFormCommonDisease tap(callable $callback)
   * @method static mixed when(callable|\TWhenParameter|null $value, callable|null $callback, callable|null $default)
   * @method static mixed unless(callable|\TUnlessParameter|null $value, callable|null $callback, callable|null $default)
   * @method static \Illuminate\Support\Collection explain()
   * @method static void macro(string $name, object|callable $macro)
   ...
   * @mixin \Illuminate\Database\Query\Builder
   */
  class FDARFormCommonDisease extends \Illuminate\Database\Eloquent\Model
  {
    //
  }
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport select(array|mixed $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport selectSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport selectRaw(string $expression)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport fromSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport fromRaw(string $expression, mixed $bindings)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport addSelect(array|mixed $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport distinct()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport from(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $table, string|null $as)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport useIndex(string $index)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport forceIndex(string $index)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport ignoreIndex(string $index)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport join(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second, string $type, bool $where)
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport joinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second, string $type, bool $where)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport joinLateral(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport leftJoinLateral(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query)
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport rightJoin(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport rightJoinWhere(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string $operator, \Illuminate\Contracts\Database\Query\Expression|string $second)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport rightJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport crossJoin(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string|null $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport crossJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport mergeWheres(array $wheres, array $bindings)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport where(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value, string $boolean)
   * @method static array prepareValueAndOperator(string $value, string $operator, bool $useDefault)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhere(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNot(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereNot(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereColumn(\Illuminate\Contracts\Database\Query\Expression|string|array $first, string|null $operator, string|null $second, string|null $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereColumn(\Illuminate\Contracts\Database\Query\Expression|string|array $first, string|null $operator, string|null $second)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereRaw(string $sql, mixed $bindings, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereRaw(string $sql, mixed $bindings)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNotLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereNotLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNotIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereNotIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereIntegerInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereIntegerInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereIntegerNotInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereIntegerNotInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNull(string|array|\Illuminate\Contracts\Database\Query\Expression $columns, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereNull(string|array|\Illuminate\Contracts\Database\Query\Expression $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNotNull(string|array|\Illuminate\Contracts\Database\Query\Expression $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereBetween(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereBetween(\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNotBetween(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNotBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereNotBetween(\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereNotBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereNotNull(\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereDate(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereDate(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereTime(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereTime(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereDay(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereDay(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereMonth(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereMonth(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereYear(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereYear(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNested(string $boolean)
   * @method static \Illuminate\Database\Query\Builder forNestedWhere()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport addNestedWhereQuery(\Illuminate\Database\Query\Builder $query, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNotExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereNotExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport addWhereExistsQuery(string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereRowValues(array $columns, string $operator, array $values, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereRowValues(array $columns, string $operator, array $values)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereJsonContains(string $column, mixed $value, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereJsonContains(string $column, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereJsonDoesntContain(string $column, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereJsonDoesntContain(string $column, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereJsonOverlaps(string $column, mixed $value, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereJsonOverlaps(string $column, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereJsonDoesntOverlap(string $column, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereJsonDoesntOverlap(string $column, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereJsonContainsKey(string $column, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereJsonContainsKey(string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereJsonDoesntContainKey(string $column, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereJsonDoesntContainKey(string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereJsonLength(string $column, mixed $operator, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereJsonLength(string $column, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport dynamicWhere(string $method, array $parameters)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereFullText(string|string[] $columns, string $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereFullText(string|string[] $columns, string $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereAll(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereAll(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereAny(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereAny(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNone(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereNone(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport groupBy(array|\Illuminate\Contracts\Database\Query\Expression|string ...$groups)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport groupByRaw(string $sql)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport having(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, string|int|float|null $operator, string|int|float|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orHaving(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, string|int|float|null $operator, string|int|float|null $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport havingNested(string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport addNestedHavingQuery(\Illuminate\Database\Query\Builder $query, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport havingNull(array|string $columns, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orHavingNull(string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport havingNotNull(array|string $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orHavingNotNull(string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport havingBetween(string $column, string $boolean, bool $not)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport havingRaw(string $sql, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orHavingRaw(string $sql)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orderBy(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column, string $direction)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orderByDesc(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport latest(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport oldest(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport inRandomOrder(string|int $seed)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orderByRaw(string $sql, array $bindings)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport skip(int $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport offset(int $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport take(int $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport limit(int $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport groupLimit(int $value, string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport forPage(int $page, int $perPage)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport forPageBeforeId(int $perPage, int|null $lastId, string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport forPageAfterId(int $perPage, int|null $lastId, string $column)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport reorder(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string|null $column, string $direction)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport union(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $query, bool $all)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport unionAll(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $query)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport lock(string|bool $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport lockForUpdate()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport sharedLock()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport beforeQuery()
   * @method static void applyBeforeQueryCallbacks()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport afterQuery()
   * @method static mixed applyAfterQueryCallbacks(mixed $result)
   * @method static string toSql()
   * @method static string toRawSql()
   * @method static IncidentReport|null find(int|string $id, array|string $columns)
   * @method static mixed findOr(mixed $id, callable|list<string>|string $columns, callable|null $callback)
   * @method static mixed value(string $column)
   * @method static mixed rawValue()
   * @method static mixed soleValue(string $column)
   ...
   * @method static array getBindings()
   * @method static array getRawBindings()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport setBindings(string $type)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport addBinding(mixed $value, string $type)
   * @method static mixed castBinding(mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport mergeBindings()
   * @method static array cleanBindings()
   * @method static \Illuminate\Database\ConnectionInterface getConnection()
   * @method static \Illuminate\Database\Query\Processors\Processor getProcessor()
   * @method static \Illuminate\Database\Query\Grammars\Grammar getGrammar()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport useWritePdo()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport clone()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport cloneWithout()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport cloneWithoutBindings()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport dump(mixed ...$args)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport dumpRawSql()
   * @method static void dd()
   * @method static void ddRawSql()
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport wherePast(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNowOrPast(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWherePast(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereNowOrPast(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereFuture(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereNowOrFuture(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereFuture(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereNowOrFuture(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereToday(array|string $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereBeforeToday(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereTodayOrBefore(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereAfterToday(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport whereTodayOrAfter(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereToday(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereBeforeToday(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereTodayOrBefore(array|string $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereAfterToday(array|string $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport orWhereTodayOrAfter(array|string $columns, string $boolean)
   * @method static bool chunk(int $count, callable $callback)
   * @method static mixed chunkMap(callable $callback, int $count)
   * @method static bool each(callable $callback, int $count)
   * @method static bool chunkById(int $count, callable $callback, string|null $column, string|null $alias)
   ...
   * @method static mixed lazyById(int $chunkSize, string|null $column, string|null $alias)
   * @method static mixed lazyByIdDesc(int $chunkSize, string|null $column, string|null $alias)
   * @method static IncidentReport|null first(array|string $columns)
   * @method static IncidentReport firstOrFail(array|string $columns, string|null $message)
   * @method static IncidentReport sole(array|string $columns)
   * @method static \Illuminate\Database\Eloquent\Builder<IncidentReport>|IncidentReport tap(callable $callback)
   * @method static mixed when(callable|\TWhenParameter|null $value, callable|null $callback, callable|null $default)
   * @method static mixed unless(callable|\TUnlessParameter|null $value, callable|null $callback, callable|null $default)
   * @method static \Illuminate\Support\Collection explain()
   * @method static void macro(string $name, object|callable $macro)
   ...
   * @property \Illuminate\Support\Carbon|null $updated_at
   * @property \Illuminate\Support\Carbon|null $created_at
   * @property int|null $prescription_number
   * @property mixed $prescription_image
   * @property int $school_physician_id
   * @property int $school_nurse_id
   * @property int $patient_id
   * @property int $id
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription whereSchoolNurseId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription whereSchoolPhysicianId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription wherePrescriptionImage($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription wherePrescriptionNumber($value)
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription whereUpdatedBy($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription whereRecordedBy($value)
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription select(array|mixed $columns)
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription addSelect(array|mixed $column)
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription whereRaw(string $sql, mixed $bindings, string $boolean)
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription having(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, string|int|float|null $operator, string|int|float|null $value, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription orHaving(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, string|int|float|null $operator, string|int|float|null $value)
   ...
   * @method static string toSql()
   * @method static string toRawSql()
   * @method static Prescription|null find(int|string $id, array|string $columns)
   * @method static mixed findOr(mixed $id, callable|list<string>|string $columns, callable|null $callback)
   * @method static mixed value(string $column)
   * @method static mixed rawValue()
   * @method static mixed soleValue(string $column)
   ...
   * @method static array getBindings()
   * @method static array getRawBindings()
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription setBindings(string $type)
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription addBinding(mixed $value, string $type)
   * @method static mixed castBinding(mixed $value)
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription mergeBindings()
   * @method static array cleanBindings()
   * @method static \Illuminate\Database\ConnectionInterface getConnection()
   * @method static \Illuminate\Database\Query\Processors\Processor getProcessor()
   * @method static \Illuminate\Database\Query\Grammars\Grammar getGrammar()
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription orWhereTodayOrBefore(array|string $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription orWhereAfterToday(array|string $columns, string $boolean)
   * @method static \Illuminate\Database\Eloquent\Builder<Prescription>|Prescription orWhereTodayOrAfter(array|string $columns, string $boolean)
   * @method static bool chunk(int $count, callable $callback)
   * @method static mixed chunkMap(callable $callback, int $count)
   * @method static bool each(callable $callback, int $count)
   * @method static bool chunkById(int $count, callable $callback, string|null $column, string|null $alias)
