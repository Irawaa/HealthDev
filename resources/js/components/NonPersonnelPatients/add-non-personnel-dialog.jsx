...
// Import Steps
import Step1 from "@/components/NonPersonnelPatients/Steps/Step1";
import Step2 from "@/components/NonPersonnelPatients/Steps/Step2";
import Step3 from "@/components/NonPersonnelPatients/Steps/Step3";
import Step4 from "@/components/NonPersonnelPatients/Steps/Step4";
import Step5 from "@/components/NonPersonnelPatients/Steps/Step5";

export default function AddNonPersonnelDialog({ open, onClose }) {
    ...
    const { data, setData, post, processing, reset } = useForm({
        ...
        updated_by: null,
        affiliation: "", height: "", weight: "", blood_type: "",
            ...
            <DialogContent className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-5xl w-full bg-white border border-green-400 shadow-2xl rounded-2xl flex flex-col p-6 md:p-8 max-h-[95vh]">
                ...
                <div className="sticky top-0 bg-white z-10 pb-3">
                    <div className="flex justify-between items-center mb-3">
                        {["Basic Info", "Personnel Details", "Address Info", "Other Details", "Review & Submit"].map((title, index) => (
