...
const Index = () => {
  ...
  const [openRoleDialog, setOpenRoleDialog] = useState(false); // State for PatientRoleDialog
  ...
  return (
    <>
      ...
      <Layout>
        ...
        {/* Patient Role Dialog */}
        {openRoleDialog && <PatientRoleDialog open={openRoleDialog} onClose={() => setOpenRoleDialog(false)} />}
      </Layout>
    </>
  );
};
