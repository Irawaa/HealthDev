...
export const DentistStaffContext = createContext();
export const useDentistStaff = () => useContext(DentistStaffContext);

export const InterviewQuestionContext = createContext();
export const useInterviewQuestion = () => useContext(InterviewQuestionContext);

// export const PatientContext = createContext();
// export const usePatient = () => useContext(PatientContext);

const PatientProfile = ({ patient, colleges, departments, commonDiseases, physicianStaff, dentistStaff, interviewQuestions }) => {
  ...
  const getInitialActiveTab = () => {
    ...
    return params.get("activeTab") || "medical";
  };

  // Call this function whenever you need to switch tabs
      ...
      <Layout>
        <CommonDiseasesContext.Provider value={commonDiseases}>
          <PhysicianStaffContext.Provider value={physicianStaff}>
            <DentistStaffContext.Provider value={dentistStaff}>
              <InterviewQuestionContext.Provider value={interviewQuestions}>
                <motion.div
